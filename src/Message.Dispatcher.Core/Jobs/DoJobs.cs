using Message.Dispatcher.Core.Comparers;
using Message.Dispatcher.Core.Jobs.Interfaces;

namespace Message.Dispatcher.Core.Jobs
{
    /// <summary>
    ...
    public static class DoJobs
    {
        ...
        {
            var dispatcherAssemblies = AppDomain.CurrentDomain.GetAssemblies().Where(assembly => assembly.FullName.Contains("Message.Dispatcher"));
            foreach (var assembly in dispatcherAssemblies) {
